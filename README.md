...
**Important**: During extension upgrades or configuration changes, Historian will not capture document changes. This maintenance window creates a temporary gap in coverage, which is a known limitation of the Firebase Extensions platform.
